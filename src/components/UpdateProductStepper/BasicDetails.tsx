...
import { validateForm } from "@/utils/validation/productValidators/basicDetails";
...
const BasicDetails: React.FC<BasicDetailsProps> = ({
  ...
  const openModal = (index?: number) => {
    if (index !== undefined) {
      ...
      setVariantForm({ size: "100gm", price: 0, discountPrice: null, imageUrl: [] });
      setEditIndex(null);
    }
    setIsModalOpen(true);
  };
  ...
  const saveVariant = (updatedData?: VariantForm) => {
    const dataToSave = updatedData || variantForm;
